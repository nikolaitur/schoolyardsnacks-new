    ...
    adminBanner.insertAdjacentHTML('beforebegin', '<div class="flash-banner mobile hidden" data-kis-r1>Mother' + "'" + 's Day Sale! Use Code <span class="discount-code">MOMSNACKS</span> in next <span class="countdown"></span> (today only!)</div>');
    ...
    emailSection.insertAdjacentHTML('beforebegin', '<div 222 class="flash-banner desktop hidden" data-kis-r2>Mother' + "'" + 's Day Sale! Use Code <span class="discount-code">MOMSNACKS</span> in next <span class="countdown"></span> (today only!)</div>');
