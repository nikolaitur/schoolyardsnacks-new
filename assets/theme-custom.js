...
(function($) {
  ...
  $(function() {
    ...
    function updateNavUrls() {
      ...
      if (getCookie(newStyleCookieName)) {
    ...
    $(document).on('click', "#add-to-cart", function() { 
      console.log("Add to cart event and upgrade modal check");
    ...
    // Rewrite any nav urls based on cookies if needed
    updateNavUrls();
